...
#define CUSTOM_MACHINE_NAME "Super Squirt Master"
...
#define Y_MAX_ENDSTOP_INVERTING fasle // Set to true to invert the logic of the endstop.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 85, 85, 400, 93 }
